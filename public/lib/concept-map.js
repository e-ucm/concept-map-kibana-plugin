define(function(require) {
    return function ConceptMap(chartElementId, infoElementId, dataJson) {
        ...
        function C(Z) {
            ...
            X.enter().append("text").attr("text-anchor", "start").attr("x", a / -2 + t).attr("y", c / 2 - t).text("all data").attr("class", "all-ditems");
            X.exit().remove()
        }
